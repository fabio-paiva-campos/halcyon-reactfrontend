...
function PalcosUser() {
  ...
  function eventoDown(id, evento, tempo, palco) {
  ...
  function eventoUp(id, evento, tempo, palco) {
                          ...
                          <>
                            {editEvento && selectedEvento === a.id ? (
                              <div className='editEventoDiv'>
                                ...
                                <button className='EventoButton' onClick={() => (editEventoAction(selectedEvento, a.filaPos, a.tempo, palcos, eventos, setEventos, setEditEvento))}>✔</button>
